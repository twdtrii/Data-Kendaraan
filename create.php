    ...
    <div class="container">       
        <?php 
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $result = "insert into tb_kendaraan (nomor_registrasi_kendaraan, nama_pemilik, merk_kendaraan, tahun_pembuatan, kapasitas_silinder, warna_kendaraan, bahan_bakar) VALUES 
                ('$nomor_registrasi_kendaraan','$nama_pemilik','$merk_kendaraan','$tahun_pembuatan','$kapasitas_silinder','$warna_kendaraan','$warna_kendaraan','$bahan_bakar')";
